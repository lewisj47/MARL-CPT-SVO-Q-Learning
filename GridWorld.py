...
def rewardFunction(agent, state, action, global_state):
    ...
    return(const1 * Goal(state, route) - const2 * collisionCheck(agent, global_state) - const3 * t - const4 * proximityCheck(agent, state, global_state) - const5 * bubbleCheck(agent, state, global_state))
